...
namespace EasyEntityFlags.SchemaGenerator
{
	...
	{
		public SchemaGenerator() : base(new EasyEntityFlagsSchemaGeneratorSettings())
		{ }
	}

	internal class EasyEntityFlagsSchemaGeneratorSettings : SystemTextJsonSchemaGeneratorSettings
	{
		public EasyEntityFlagsSchemaGeneratorSettings()
		{
